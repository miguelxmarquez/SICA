...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <title>SICA: Nuevo Usuario</title>
    ...
    <body onload="document.datos.nombre.focus()">
                    ...
                    <ul class="clear">
                        ...
                        <li class="active">
                            ...
                            <ul>
                                ...
                                <li><a href="buscar_orden.php">Buscar</a></li>
        ...
        <form id="datos" name="datos" method="POST" class="validate-form form bt-space15" action="guarda_usuario.php">
                                            ...
                                            <table class="style1">
                                                ...
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <td> <input size="38" value="<?php echo $_GET["nombre"] ?>" type="text" name="nombre" id="nombre" class="required text fl-space2" onkeypress="return permite(event, 'l')"></input></td>
                                                        <th>Apellido<span class="required"> *</span></th>
                                                        <td><input size="38" value="<?php echo $_GET["apellido"] ?>" type="text" name="apellido" id="apellido" class="required text fl-space2" onkeypress="return permite(event, 'l')"></input></td>
                                                    </tr>
                                                    <tr>
                                                        <th>Nombre de Usuario<span class="required"> *</span></th>
                                                        <td> <input size="38" value="<?php echo $_GET["username"] ?>" type="text" name="username" id="username" class="required text fl-space2" onkeypress="return permite(event, 'l')"></input></td>
                                                        <th>Rol de Usuario<span class="required"> *</span></th>
                                                        <td><select id="rol" name="rol" class="fl-space2 required" >
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><input size="38" type="password" name="pass" id="pass" class="required text fl-space2"></input></td>
                                                        <th>Confirmar Contraseña<span class="required"> *</span></th>
                                                        <td><input size="38" type="password" name="repass" id="repass" class="required text fl-space2"></input></td>
                                                    </tr>
                                                    <tr>
                                                        <th>Correo Electrónico<span class="required"> *</span></th>
                                                        <td><input size="38" value="<?php echo $_GET["email"] ?>" type="trext" name="email" id="email" class="required text fl-space2"></input></td>
                                                        <td></td>
                                                        <td></td>
                                                    </tr>
                                                </tbody>
