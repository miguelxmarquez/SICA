        ...
        <div class="pagetop">
            <div class="head pagesize"> <!-- *** head layout *** -->
                <div class="head_top">
                    <div class="topbuts">
                        <ul class="clear">
                            <li><a href="manual.pdf" class="green" target="_blank">Ayuda</a></li>
                ...
                <div class="menu">
                    <ul class="clear">
                        <li class="active"><a href="#">Panel de Administración</a></li>
                    </ul>
                </div>
            </div>
        </div>
        ...
        <div class="main pagesize"> <!-- *** mainpage layout *** -->
		    ...
		    <p><strong>Notificación:</strong> El Registro no ha sido guardado, intentelo de nuevo. Error inesperado en la insercion del registro en la base de datos</p>
                ...
                if ($_GET["id"] == "existe") {
                    ...
                    <a href=\"#\" class=\"close\" title=\"Close notification\"><span>Cerrar</span></a>
		    <span class=\"icon\"></span>
		    <p><strong>Notificación:</strong> La cédula de la persona ya está registrada en el sistema, realice una búsqueda.</p>
		  </div>";
                }
                if ($_GET["id"] == "deleted") {
                    echo "<div class=\"notification note-error\">
                    <a href=\"#\" class=\"close\" title=\"Close notification\"><span>Cerrar</span></a>
		    <span class=\"icon\"></span>
		    <p><strong>Notificación:</strong> El registro ha sido eliminado exitosamente.</p>
		  </div>";
                }
                if ($message = $_GET["db"]) {
                    echo "<div class=\"notification note-success\">
                        ...
                        <div class="box-body iconbar">
                            <div class="box-wrap">
                                <div class="main-icons" id="iconbar">
                                    <ul class="clear">
                                        <li><a href="nuevo_profesor.php"><img src="../../images/ico_page_64.png" class="icon" alt="" /><span class="text">Nuevo Profesor</span></a></li>
                                        <li><a href="buscar_registro.php"><img src="../../images/10.png" class="icon" alt="" /><span class="text">Buscar Profesor</span></a></li>
                                        <li><a href="horarios.php"><img src="../../images/ico_clock_64.png" class="icon" alt="" /><span class="text">Horarios</span></a></li>
                                        <li><a href="asistencias.php"><img src="../../images/ico_folder_64.png" class="icon" alt="Asistencias" /><span class="text">Asistencias</span></a></li>
                                        <li><a href="materias.php"><img src="../../images/archive.png" class="icon" alt="" /><span class="text">Materias</span></a></li>
                                        <li><a href="reportes.php"><img src="../../images/obinet.png" class="icon" alt="" /><span class="text">Reportes</span></a></li>
                                        <li><a href="usuarios.php"><img src="../../images/ico_users_64.png" class="icon" alt="" /><span class="text">Usuarios</span></a></li>
                                        <li><a href="mantenimiento.php"><img src="../../images/ico_settings_64.png" class="icon" alt="" /><span class="text">Mantenimiento</span></a></li>
                                    </ul>
                                </div>
                            </div>
                        </div>
                    ...
                    <div class="content-box">
                        <div class="box-body">
                            <div class="box-header clear">
                                <h2>Ultimos 100 Registros de Profesores</h2>
                            </div>
                                            ...
                                            <tbody>
                                                ...
                                                while (@$A = mysql_fetch_array($result)) {
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td style="padding-left: 30px;"><a href="registro.php?id=<?php echo $A["id"] . "&ci=" . $A["ci"]; ?>"><?php echo $A["fecha_n"] ?></a></td>
