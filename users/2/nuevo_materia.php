...
<html xmlns="http://www.w3.org/1999/xhtml">
    <head>
        ...
        <title>SICA: Nueva Materia</title>
    ...
    <body onload="document.datos.nombre.focus()">
        ...
        <form id="datos" name="datos" method="POST" class="validate-form form bt-space15" action="guarda_materia.php">
		    ...
		    <p><strong>Notificación:</strong> La materia no pudo ser actualizada, verifique los datos e intentelo de nuevo.</p>
		  </div>";
                    }
                    ?>
                                            ...
                                            <table class="style1">
                                                ...
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <td> <input value="<?php echo $_GET["nombre"] ?>" type="text" name="nombre" id="nombre" class="required text fl-space2" size="50"></input></td>
                                                        <th>Seccion<span class="required"> *</span></th>
                                                        <td>
                                                            <select name="seccion" class="required">
                                                                <option></option>
                                                        ...
                                                        <td>
                                                            <select name="especialidad" class="required">
                                                                <option></option>

                                                                <?php
                                                                $sql = "SELECT * FROM escuelas ORDER BY especialidad";
                                                                $result = mysql_query($sql);
                                                                $i = 0;
                                                                while ($row = mysql_fetch_array($result)) {
