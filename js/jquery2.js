...
remove:function(a,b,c,d){
    ...
    if(!!e&&!!(m=e.events)){
        ...
        for(g=0;g<b.length;g++){
            ...
            if(!i){
                j=j?"."+j:"";
                for(l in m)f.event.remove(a,l+j,c,d);return
            }
...
animate:function(a,b,c,d){
    function g(){
        ...
        for(i in a)j=new f.fx(this,b,i),h=a[i],cp.test(h)?(o=f._data(this,"toggle"+i)||(h==="toggle"?d?"show":"hide":0),o?(f._data(this,"toggle"+i,o==="show"?"hide":"show"),j[o]()):j[h]()):(k=cq.exec(h),l=j.cur(),k?(m=parseFloat(k[2]),n=k[3]||(f.cssNumber[i]?"":"px"),n!=="px"&&(f.style(this,i,(m||1)+n),l=(m||1)/j.cur()*l,f.style(this,i,l+n)),k[1]&&(m=(k[1]==="-="?-1:1)*m+l),j.custom(l,m,n)):j.custom(l,h,""));return!0
        }
        var e=f.speed(b,c,d);
